...
class PagoRemuneracionController extends Controller
{
/**
...
{
$dataProvider=new CActiveDataProvider('PagoRemuneracion');
...
{
$model=PagoRemuneracion::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='pago-remuneracion-form')
{

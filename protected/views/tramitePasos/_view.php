<div class="view">
		...
		<b><?php echo CHtml::encode($data->getAttributeLabel('id_tramite_pasos')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_tramite_pasos),array('view','id'=>$data->id_tramite_pasos)); ?>
	<br />

 ...
 *
 * The followings are the available columns in table 'rango':
...
class Rango extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_rango, descripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'clientes' => array(self::HAS_MANY, 'Cliente', 'id_rango'),
			'tramites' => array(self::HAS_MANY, 'Tramite', 'id_rango'),
		);
	}

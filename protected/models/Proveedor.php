...
class Proveedor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_proveedor, descripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tramitePasoses' => array(self::HAS_MANY, 'TramitePasos', 'id_proveedor'),
			'tramites' => array(self::HAS_MANY, 'Tramite', 'id_proveedor'),
		);
	}
